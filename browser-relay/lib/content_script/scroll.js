/**
 * Extension.scroll / Extension.browserScroll — Page and container scrolling with verification.
 *
...
/** @param {string} [unwrapLabel] 错误信息前缀（与 dispatch 中的虚拟方法名一致） */
export async function extScroll(tabId, params, unwrapLabel = 'Extension.scroll') {
  ...
  return unwrapScriptResult(results, unwrapLabel)
}
